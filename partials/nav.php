      ...
      <div class="header-content-search">
        <form action="javascript:void(0);"> <!--This prevents the page from reloading when you hit enter - the search field provides results as a dropdown menu only -->
          <div>
            <ul id="searchList">
            <li>
              <a href="testingandsafety\testingandtagging\">Appliance Testing and Tagging</a>
              </li>
              <li>
              <a href="testingandsafety\rcdtesting\">RCD Testing</a>
            </li>
            <li>
              <a href="testingandsafety\microwavetesting\">Microwave Testing</a>
            </li>
            <li>
              <a href="testingandsafety\thermography\">Thermography</a>
            </li>
            <li>
              <a href="testingandsafety\lightleveltesting\">Light Level Testing</a>
            </li>
            <li>
              <a href="testingandsafety\emergencyexitlighttesting\">Emergency Exit Light Testing</a>
            </li>
            <li>

              <a href="dataandelectrical\electricalcontracting\">Electrical Contracting</a>
            </li>
            <li>
              <a href="dataandelectrical\solar\">Solar Installations</a>
            </li>
            <li>
              <a href="dataandelectrical\datacabling\">Data Cabling</a>
            </li>
            <li>

              <a href="otherservices\assetmanagement\">Asset Management</a>
            </li>
            <li>
              <a href="otherservices\security\">Security Systems</a>
            </li>
            <li>
              <a href="otherservices\lighting\">Lighting Installations</a>
            </li>
            <li>
